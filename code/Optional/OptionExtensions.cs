...
namespace Mikodev.Optional
{
    ...
    public static class OptionExtensions
    {
        ...
        {
            return option.Intent(out var data) is OptionData.Some ? data : @default;
        }
        ...
        public static T UnwrapOrElse<T>(this Option<T> option, Func<T> func)
        {
            ...
            return option.Intent(out var data) is OptionData.Some ? data : func.Invoke();
        }
        ...
        public static Option<U> Map<T, U>(this Option<T> option, Func<T, U> func)
        {
            if (func == null)
                throw new ArgumentNullException(nameof(func));
            return option.Intent(out var data) is OptionData.Some ? Option<U>.Some(func.Invoke(data)) : Option<U>.None();
        }
        ...
        public static U MapOr<T, U>(this Option<T> option, U @default, Func<T, U> func)
        {
            if (func == null)
                throw new ArgumentNullException(nameof(func));
            return option.Intent(out var data) is OptionData.Some ? func.Invoke(data) : @default;
        }
        ...
        public static U MapOrElse<T, U>(this Option<T> option, Func<U> @default, Func<T, U> func)
        {
            ...
            if (func == null)
                throw new ArgumentNullException(nameof(func));
            return option.Intent(out var data) is OptionData.Some ? func.Invoke(data) : @default.Invoke();
        }

        public static Result<T, E> OkOr<T, E>(this Option<T> option, E error)
        {
            return option.Intent(out var data) is OptionData.Some ? Result<T, E>.Ok(data) : Result<T, E>.Error(error);
        }
        ...
        public static Result<T, E> OkOrElse<T, E>(this Option<T> option, Func<E> func)
        {
            if (func == null)
                throw new ArgumentNullException(nameof(func));
            return option.Intent(out var data) is OptionData.Some ? Result<T, E>.Ok(data) : Result<T, E>.Error(func.Invoke());
        }
        ...
        public static Option<U> AndThen<T, U>(this Option<T> option, Func<T, Option<U>> func)
        {
            if (func == null)
                throw new ArgumentNullException(nameof(func));
            return option.Intent(out var data) is OptionData.Some ? func.Invoke(data) : Option<U>.None();
        }
        ...
        {
            return option.Intent(out var data) is OptionData.Some
                ? data.Intent(out var ok, out var error) is ResultData.Ok
        ...
        {
            return option.Intent(out var data) is OptionData.Some && data.Intent(out var item) is OptionData.Some
                ? Option<T>.Some(item)
                : Option<T>.None();
        }
    }
